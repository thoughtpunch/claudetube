...
VIDEO_PROVIDERS: list[dict] = [
    ...
    },
    {
        "rank": 50,
        "name": "Peertube",
        "domains": ["peertube.tv", "tube.tchncs.de", "video.ploud.fr"],
